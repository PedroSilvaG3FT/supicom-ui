import { IProductCategory, IProductItem } from "../interface/product.interface";

export const PRODUCT_CATEGORY_DATA: IProductCategory[] = [
...
const getCategoryById = (id: number) =>
  PRODUCT_CATEGORY_DATA.find((item) => item.id === id) ||
  ({} as IProductCategory);
...
export const PRODUCTS_DATA: IProductItem[] = [
  {
    ...
    description:
      "Equipamento de alta precisão para corte de madeira, ideal para marcenarias e serrarias.",
  ...
  },
  {
    ...
    images: ["/images/products/example.jpg"],
    description:
      "Prensa de alta capacidade para produção em larga escala de produtos cerâmicos.",
  ...
  },
  {
    ...
    images: ["/images/products/example.jpg"],
    description:
      "Impressora de alta qualidade para litografia, utilizada na produção gráfica em grandes volumes.",
  ...
  },
  {
    ...
    images: ["/images/products/example.jpg"],
    description:
      "Guindaste compacto ideal para obras de pequeno e médio porte, disponível para locação.",
    bannerImage: "https://images.unsplash.com/photo-1504384308090-c894fdcc538d",
  ...
  },
  {
    ...
    images: ["/images/products/example.jpg"],
    description:
      "Pacote de câmeras de segurança para monitoramento industrial, com suporte a ambientes adversos.",
    bannerImage: "https://images.unsplash.com/photo-1504384308090-c894fdcc538d",
